    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if self.is_container and self.can_contain(place.ant):
                ...
                place.ant=self
                f=1
            assert f==1, 'Too many ants in {0}'.format(place)
            # END Problem 8b
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        if self.health<=amount:
            amount=self.damage+self.health
        for bee in self.place.bees[:]:
            bee.reduce_health(min(bee.health,amount))
            print("DEBUG:",bee)
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while(t):
            ...
            if t.ant:
                a[t.ant]=dis
                print("DEBUG:",t.ant,':',dis)
                if t.ant.is_container and t.ant.ant_contained:
                    a[t.ant.ant_contained]=dis
            dis+=1
            t=t.entrance
        return a
        # END Problem Optional 2
